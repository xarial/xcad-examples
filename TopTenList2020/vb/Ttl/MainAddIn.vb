...
Namespace ttl
    ...
    Public Enum Commands_e
        ...
        <CommandItemInfo(True, True, WorkspaceTypes_e.Assembly Or WorkspaceTypes_e.Part, True)>
        ZoomGeometryToFit
    ...
    Public Class MainAddIn
        ...
        Private Sub ZoomGeometryToFit()
            ...
            Dim bbox = model.Evaluation.PreCreateBoundingBox()
            bbox.Precise = True
            bbox.Commit()
        ...
        Private Sub HideShowBodies()
            Const swCommands_View_Hideshow = 1390
            Application.Sw.RunCommand(swCommands_View_Hideshow, "")
        End Sub

        Private Sub InsertShaftChamfer()
            Application.Documents.Active.Features.InsertCustomFeature(Of ShaftChamferMacroFeatureDefinition, ShaftChamferData, ShaftChamferData)()
        End Sub
    End Class
End Namespace
